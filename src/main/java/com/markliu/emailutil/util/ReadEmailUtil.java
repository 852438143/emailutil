...
public class ReadEmailUtil {
	...
	public static void main(String args[]) throws Exception {
		...
		String username = "SunnyMarkLiu@163.com";
		String password = "sqmmjlqwd992101";
		...
		ReadEmailUtil re = null;

		for (int i = 0; i < message.length; i++) {
			re = new ReadEmailUtil((MimeMessage) message[i]);
